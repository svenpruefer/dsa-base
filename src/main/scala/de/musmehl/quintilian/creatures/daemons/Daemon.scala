...
sealed trait NiedererDaemon extends Daemon

sealed trait GehoernterDaemon extends Daemon

object Daemon {
  case object Achorhobai extends GehoernterDaemon

  case object Agribaal extends GehoernterDaemon

  case object BrukhaKlah extends NiedererDaemon
}
